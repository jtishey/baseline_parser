...
from modules.jinja2.visitor import NodeVisitor
from modules.jinja2.exceptions import TemplateAssertionError
from modules.jinja2.utils import Markup, concat, escape
from modules.jinja2._compat import range_type, text_type, string_types, \
...
class CodeGenerator(NodeVisitor):
    ...
    def visit_Template(self, node, frame=None):
        ...
        from modules.jinja2.runtime import __all__ as exported
        self.writeline('from __future__ import division')
        self.writeline('from modules.jinja2.runtime import ' + ', '.join(exported))
